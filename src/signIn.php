...
<div class="min-h-screen flex items-center justify-center w-full ">
	<div class="bg-gray-50 shadow-md rounded-lg px-8 py-6 max-w-md">
		<h1 class="text-2xl font-bold text-center mb-4 dark:text-gray-500">Welcome To New User!</h1>
		<form action="Controller/signIn_controller.php" method="post">
            ...
            <div class="mb-4">
				<label for="opt" class="block text-sm font-medium text-gray-700  mb-2">Select The Role :</label>
				<select name="role" id="opt" class="w-full h-10 bg-white rounded-md">
